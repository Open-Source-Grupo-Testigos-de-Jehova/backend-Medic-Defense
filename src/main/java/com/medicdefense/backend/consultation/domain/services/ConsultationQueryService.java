...
import com.medicdefense.backend.consultation.domain.model.queries.GetConsultationsByIdQuery;
...
public interface ConsultationQueryService {
    ...
    Consultation getConsultationById(GetConsultationsByIdQuery query);
