...
public class Message {
    ...
    public void addMessageItems(LegalIssue legalIssue, String message, ProfileId sender) {
        System.out.println("Adding message item");
        Date date = new Date(System.currentTimeMillis());
        MessageItem messageItem = new MessageItem(date, legalIssue, message, sender);
